        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-center">
          <div>
            <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold leading-tight text-gray-900">
              Meet Our Dedicated Team of Innovators
            </h2>
            ...
            <p className="mt-6 text-base sm:text-lg text-gray-700 leading-8">
              ...
              mission to deliver high-quality disposable surgical equipment that
              meets the evolving needs of healthcare organisations across India.
              We are committed to fostering a culture of collaboration and
              continuous improvement, ensuring that our products not only adhere
              to industry standards but also exceed our customers' expectations.
            </p>
          </div>
      ...
      <div className=" py-5 flex flex-col lg:flex-row items-center justify-between gap-10">
        ...
        <div className="lg:w-1/2">
          ...
          <p className="text-gray-600 mb-6">
            ...
            Follow <br className="hidden md:block" /> these easy steps to order
            your desired products today!
          </p>
